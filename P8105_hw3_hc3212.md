...
| product_name     | digit | Sunday | Monday | Tuesday | Wednesday | Thursday | Friday | Saturday |
|:-----------------|------:|-------:|-------:|--------:|----------:|---------:|-------:|---------:|
| Coffee Ice Cream |     2 |     13 |     15 |      15 |        15 |       15 |     10 |       12 |
| Pink Lady Apples |     2 |     12 |     12 |      12 |        14 |       12 |     14 |       12 |
...
brfss_df =
  ...
  mutate(
    response = 
      fct_relevel(response, c("Excellent", "Very Good", "Good", "Fair", "Poor")))
```
